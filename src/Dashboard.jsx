                    ...
                    <div style={{ height: "720px", margin: 0,padding:0, width: "300px" }}>
                        ...
                        >
                            ...
                            <Menu menuItemStyles={{ root: { ":hover": {  color: "blue",backgroundColor:"red",marginLeft:"10px" } } }}>
                                ...
                                <br />
                                <MenuItem icon={<FontAwesomeIcon icon={faMoneyCheck} color='grey' />} style={{ fontWeight: 600 }}>Transaction History</MenuItem>
                                <br />
                                <MenuItem icon={<FontAwesomeIcon icon={faAddressBook} color='grey' />} style={{ fontWeight: 600 }}>About Us</MenuItem>
                                <br />
                                <MenuItem icon={<FontAwesomeIcon icon={faContactBook} color='grey' />} style={{ fontWeight: 600 }}>Contact Us</MenuItem>
                                <br />
